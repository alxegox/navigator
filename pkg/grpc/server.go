...
func NewAPI(log logrus.FieldLogger, metrics *observability.Metrics, resources ResourceGetter) *grpc.Server {
	...
	s.grpcMetrics.InitializeMetrics(g)
	metrics.MustRegister(s.grpcMetrics)
	return g
}
