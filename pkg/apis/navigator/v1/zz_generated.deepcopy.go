...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InboundPort) DeepCopyInto(out *InboundPort) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InboundPort.
func (in *InboundPort) DeepCopy() *InboundPort {
	if in == nil {
		return nil
	}
	out := new(InboundPort)
