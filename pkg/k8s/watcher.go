...
import (
	...
	navigatorInformer "github.com/alxegox/navigator/pkg/apis/generated/informers/externalversions/navigator/v1"
...
var (
	...
	ingressesName = "ingresses"
	canariesName  = "canaries"
	nexusesName   = "nexuses"
...
func NewWatcher(
	...
	canaryReleaseEventHandler := NewCanaryReleaseEventHandler(logger, metrics, k8sCache, canary, clusterID, epLister, endpointEventHandler)
	nexusHandler := NewNexusEventHandler(logger, metrics, k8sCache, nexusCache, notifier, notifier, clusterID)
...
func (w *watcher) Start(ctx context.Context) {
	...
	w.logger.WithField("delay", delay.String()).Warnln("cache synced")
}
